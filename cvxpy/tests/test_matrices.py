...
class TestMatrices(unittest.TestCase):
    ...
    def test_numpy_arrays(self):
        ...
        self.assertEqual((self.x + v).size, (2,1))
        self.assertEqual((v + self.x).size, (2,1))
        self.assertEqual((self.x - v).size, (2,1))
        self.assertEqual((v - self.x).size, (2,1))
        self.assertEqual((self.x <= v).size, (2,1))
        self.assertEqual((v <= self.x).size, (2,1))
        ...
        self.assertEqual((A*self.x).size, (4,1))
    ...
    def test_numpy_matrices(self):
        ...
        self.assertEqual((self.x + v).size, (2,1))
        self.assertEqual((v + v + self.x).size, (2,1))
        self.assertEqual((self.x - v).size, (2,1))
        self.assertEqual((v - v - self.x).size, (2,1))
        self.assertEqual((self.x <= v).size, (2,1))
        self.assertEqual((v <= self.x).size, (2,1))
        ...
        self.assertEqual((A*self.x).size, (4,1))
        self.assertEqual(( (A.T*A) * self.x).size, (2,1))
